      ...
      <section className="bg-[#0a0a0a] py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mb-6 text-3xl font-bold text-white sm:text-4xl">
              What <span className="text-gradient">Sponsors Receive</span>
            </h2>
            <p className="text-lg text-white/60">
              Partner with HCR and gain visibility while supporting student engineering excellence.
              Contact us for detailed sponsorship information.
            </p>
          </motion.div>

          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Award, title: "Brand Visibility", desc: "Logo placement on robot, website, and team apparel" },
              { icon: Users, title: "Talent Access", desc: "Connect with motivated engineering students" },
              { icon: Globe, title: "Event Presence", desc: "Recognition at competitions and university events" },
              { icon: Zap, title: "Social Media", desc: "Featured posts across our digital platforms" },
              { icon: Star, title: "Recruitment", desc: "Access to team recruitment events" },
              { icon: Check, title: "Progress Updates", desc: "Regular reports on team achievements" },
            ].map((benefit, index) => (
              <motion.div
                key={benefit.title}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <Card className="h-full border-white/10 bg-[#141414] transition-all duration-300 hover:border-[#E5005B]/30">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#E5005B]/10">
                      <benefit.icon className="h-6 w-6 text-[#E5005B]" />
                    </div>
